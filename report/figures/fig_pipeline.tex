\begin{figure}[h]
    ...
    \end{tikzpicture} 
    \caption{Répartition des bindings par \peneloop avec l'approche pipeline, où $tp_1, tp_2$ sont des triples patterns, $E_1$ la source pertinente pour $tp_1$ et $E_2, E_3, E_4$ les répliques utilisées comme sources de $tp_2$.}
    \label{fig:pipeline}
\end{figure}